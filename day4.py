...
while i<length:
    ...
    if numsplit1 >= numsplit3 and numsplit2 <= numsplit4:
        sum += 1
        sum2 += 1
    elif numsplit3>= numsplit1 and numsplit4 <= numsplit2:
        sum += 1
        sum2 += 1
    elif numsplit3<=numsplit2 and numsplit3>=numsplit1:
        sum2 += 1
    elif numsplit1<=numsplit4 and numsplit1>=numsplit3:
        sum2 += 1
    i+=1
print(sum)
print(sum2)